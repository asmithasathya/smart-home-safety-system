...
DEFAULT_ALARM_SOUND = ASSET_DIR / "alarm.m4a"
DEFAULT_NIGHT_SOUND = ASSET_DIR / "goodnight_sound.mp3"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--sound",
        default=str(DEFAULT_ALARM_SOUND),
        help="Sound file to play with afplay (default: host/assets/alarm.m4a)",
    )
    parser.add_argument(
        "--night-sound",
        default=str(DEFAULT_NIGHT_SOUND),
        help="One-shot sound file for Night mode (default: host/assets/goodnight_sound.mp3)",
    )
    parser.add_argument(
        "--cooldown-ms",
        type=int,
